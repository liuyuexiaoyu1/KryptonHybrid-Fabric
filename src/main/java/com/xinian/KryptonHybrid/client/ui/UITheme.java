...
public final class UITheme {
    ...
    // ??? Rounded rect ???
    public static void fillRoundedRect(KryptonGuiGraphics g, int x, int y, int w, int h, int radius, int color) {
    ...
    private static void fillRoundedCorner(KryptonGuiGraphics g, int cx, int cy, int r, int color, boolean left, boolean top) {
    ...
    private static void fillCorner(KryptonGuiGraphics g, int cx, int cy, int r, int color, boolean left, boolean top) {
    ...
    public static void drawRoundedBorder(KryptonGuiGraphics g, int x, int y, int w, int h, int radius, int color) {
    ...
    public static void fillGradient(KryptonGuiGraphics g, int x, int y, int w, int h, int colorTop, int colorBottom) {
        if (h <= 0 || w <= 0) return;
    ...
    public static void drawHLine(KryptonGuiGraphics g, int x, int y, int width, int color) {
    ...
    public static void drawCardShadow(KryptonGuiGraphics g, int x, int y, int w, int h, int radius) {
        var c = colors();
        for (int i = 4; i >= 1; i--) {
            int alpha = 8 - i * 2;
    ...
    public static void renderTooltipBackground(KryptonGuiGraphics g, int x, int y, int w, int h) {
        var c = colors();
